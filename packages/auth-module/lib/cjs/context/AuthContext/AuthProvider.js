...
function AuthProvider(_a) {
    ...
    var logout = (0, react_1.useCallback)(function () {
        TokenHandler_1.default.unregisterToken();
        setUser(null);
        setToken('');
        // window.location.href = `${process.env.NEXT_PUBLIC_AUTH_PORTAL_URL}?app="${window.location.href}"`
    }, []);
    var saveLoginCredentials = (0, react_1.useCallback)(function (newToken, newUser) {
        setToken(newToken);
        setUser(newUser);
    }, []);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, (0, services_1.login)(email, password)];
                case 2:
                    response = _a.sent();
    ...
    var validateToken = (0, react_1.useCallback)(function (token) { return __awaiter(_this, void 0, void 0, function () {
        var response, e_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
    ...
    return (react_1.default.createElement(AuthContext_1.default.Provider, { value: {
            user: user,
            token: token,
